...
# base
PACKAGE="$PACKAGE busybox uci luci uhttpd opkg curl openssl-util ds-lite e2fsprogs lsblk zram-swap"
# packages
PACKAGE="$PACKAGE bash luci-base wget-ssl openssh-sftp-server htop"
